...
const contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if(!name || !email || !message) {
        ...
        try{
            fetch('https://carlitos33.app.n8n.cloud/webhook/8070ac45-2f4a-4d7e-813a-2ebe2960f80c', {
                method: 'POST',
                headers: {
  ...
  return (
    <div>
        <section className="min-h-screen bg-gradient-to-r from-primary via-blue-800 to-white">
